//
//  TX_WKG_VideoPasterTextViewController.m
//  SmartCity
//
...
@interface TX_WKG_VideoPasterTextViewController ()<VideoPreviewDelegate, UICollectionViewDelegate,UICollectionViewDataSource,RangeContentDelegate, VideoTextFieldDelegate,PasterSelectViewDelegate>
{
...
@implementation TX_WKG_VideoPasterTextViewController
...
- (void)initUI{
    ...
    _videoPreview.delegate = self;
    _ugcEditer.previewDelegate = _videoPreview;
