...
#define playBtnWidth   42
#define playBtnHeight  42
#define pauseBtnWidth  42
...
- (instancetype)initWithFrame:(CGRect)frame coverImage:(UIImage *)image
{
    if (self = [super initWithFrame:frame]) {
        _renderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0,CGRectGetWidth(frame), CGRectGetHeight(frame))];
...
{
    if (videoIsPlay) {
        [_playBtn setBackgroundImage:[UIImage imageNamed:@"pausepreview"] forState:UIControlStateNormal];
          _coverView.hidden = YES;
    }else{
        [_playBtn setBackgroundImage:[UIImage imageNamed:@"startpreview"] forState:UIControlStateNormal];
    }
