...
- (void)iniSubViews
{
    ...
    for (int i = 0; i < _imageList.count; i++) {
        CGRect imgFrame = CGRectMake(_appearanceConfig.pinWidth + i*[self imageWidth],
                                     ...
                                     [self imageWidth],
                                     _appearanceConfig.thumbHeight - _appearanceConfig.borderHeight*2.f);
    ...
    self.leftPin = ({
        ...
        imageView.height = _appearanceConfig.thumbHeight;
...
- (void)layoutSubviews {
    ...
    self.leftPin.center   = CGPointMake(self.leftPinCenterX, self.height /2 - _appearanceConfig.borderHeight);
    self.centerPin.center = CGPointMake(self.centerPinCenterX, self.height / 2 - _appearanceConfig.borderHeight);
    self.rightPin.center  = CGPointMake(self.rightPinCenterX, self.height /2 - _appearanceConfig.borderHeight);
    ...
    self.leftCover.height = _appearanceConfig.thumbHeight - _appearanceConfig.borderHeight;
    self.leftCover.width = self.leftPinCenterX;
    self.leftCover.y = _appearanceConfig.borderHeight;
    self.leftCover.x = 0;
    
    self.rightCover.height = _appearanceConfig.thumbHeight - _appearanceConfig.borderHeight;
