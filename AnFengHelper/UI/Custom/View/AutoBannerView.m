...
@interface AutoBannerView () <UIScrollViewDelegate>
//定时器
...
- (id)initWithFrame:(CGRect)frame animationDuration:(NSTimeInterval)animationDuration
{
    ...
    self.cycleScrollPageControlAliment = AutoBannerScrollPageContolAlimentCenter;
...
- (void)layoutSubviews
{
    ...
    if (self.cycleScrollPageControlAliment == AutoBannerScrollPageContolAlimentCenter) {
...
{
    if (self.autoBannerItemCallBack) {
        ...
        self.autoBannerItemCallBack(currentSelectIndex,model);
    }
}
