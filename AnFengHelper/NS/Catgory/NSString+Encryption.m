...
{
    const char *value = [sourceString UTF8String];
...
{
    if (text && ![text isEqualToString:kLocalStringEmpity]) {

        NSData *data = [text dataUsingEncoding:NSUTF8StringEncoding];
        return [self base64EncodedStringFrom:data];
    }
    else {
        return kLocalStringEmpity;
    }
}
#pragma mark  -将base64位字符转变 NSString
+ (NSString *)textFromBase64String:(NSString *)base64;
{

    if (base64 && ![base64 isEqualToString:kLocalStringEmpity]) {
